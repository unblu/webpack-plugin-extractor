...
class Extractor {
    constructor(opts) {
        console.log("Unblu WebpackPluginExtractor (v5.0.3) created.");
    ...
    apply(compiler) {
        compiler.hooks.compilation.tap('WebpackPluginExtractor', (compilation) => {
            compilation.hooks.processAssets.tap({ name: 'WebpackPluginExtractor', stage: Compilation.PROCESS_ASSETS_STAGE_REPORT, additionalAssets: true }, (chunks) => {
